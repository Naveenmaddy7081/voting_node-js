...
//             return res.status(404).json({message: 'user has not admin role 1'});
...
//         if (!response){
//             return res.status(404).json({error:'candidate not fond'});
//         }
...
//     try{
//         if(! await checkAdminRole(req.user.id))
//         return res.status(404).json({message: 'user has not admin role 11'});
